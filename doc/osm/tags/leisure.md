...
The drone simulator uses `leisure` tags for reference and area identification:

**Rendering as green space (color #90b860):**
- park, garden (may overlap with landuse)

**Facilities mapped as areas:**
- sports_hall, stadium, swimming_pool, golf_course, camping

**Nodes and small features:**
- playground, picnic_table, tennis_court
