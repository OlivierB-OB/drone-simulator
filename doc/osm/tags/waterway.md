...
The drone simulator uses `waterway` tags for linear water rendering via `waterwayWidthsMeters` in config.ts:

**Rivers (color #3a6ab0):**
- `river` - Width: 20 meters

**Canals (color #3a6ab0):**
- `canal` - Width: 15 meters

**Streams (color #3a6ab0):**
- `stream` - Width: 5 meters

**Tidal/specialty (color #3a6ab0):**
- `tidal_channel` - Width: 10 meters
- `dam` - Width: 10 meters
- `weir` - Width: 5 meters

**Small features:**
- `ditch` - Width: 2 meters
- `drain` - Width: 2 meters

## Usage Notes

- Applied to ways (linear features only)
- River/stream centerline typically mapped, width rendered from config
