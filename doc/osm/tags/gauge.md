...
The drone simulator documents the following gauges for reference (no active gauge-specific rendering currently):

**Standard values:**
- `1435` - Standard gauge (most railways globally)
- `1520` - Russian/Eastern European railways
- `1676` - Indian railways

**Narrow gauges:**
- `1000` - Meter gauge (used in some regions)
- `762` - Heritage/mountain railways
