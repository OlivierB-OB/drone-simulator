...
The drone simulator uses `diameter` for tree and structure rendering:

**Tree trunk diameters (at DBH, 1.3m):**
- Small saplings: 5-10 cm
- Young trees: 10-30 cm
- Mature trees: 30-100 cm
- Large/heritage trees: 100-200+ cm

**Structure/pole diameters:**
- Utility poles: 20-30 cm
- Antenna masts: 5-15 cm
- Tower/chimney base: 2-5 meters
