...
The drone simulator uses `roof:shape` with corresponding color defaults:

- `flat` (color #a0a090) — Modern flat-roof buildings
- `pitched` (color #906050) — Traditional pitched/gabled roofs

**Note:** The simulator groups most pitched shapes (gabled, hipped, mansard, etc.) into the `pitched` category with a single default color. Specific roof:material tags provide additional color variation.
