...
The drone simulator uses `diameter:crown` for vegetation mesh generation:

**Tree crown sizes from vegetationMeshConfig:**
- Forest trees: `crownRadiusMin: 2m` to `crownRadiusMax: 5m` (diameter 4-10m)
- Scrub vegetation: `crownRadiusMin: 1m` to `crownRadiusMax: 2.5m` (diameter 2-5m)
- Orchard trees: `crownRadiusMin: 1.5m` to `crownRadiusMax: 2.5m` (diameter 3-5m)
- Tree rows: `crownRadiusMin: 1.5m` to `crownRadiusMax: 3m` (diameter 3-6m)

**Typical measured values:**
- Small trees: 4-6 meters
- Medium trees: 8-12 meters
- Large mature trees: 15-25+ meters
