...
The drone simulator uses `circumference` as reference data for individual trees:

**Typical circumference ranges (in centimeters at DBH):**
- Small young trees: 30-60 cm (diameter ~10-19 cm)
- Medium trees: 60-150 cm (diameter ~19-48 cm)
- Large mature trees: 150-300+ cm (diameter ~48-95+ cm)

**Example notable trees:**
- Small saplings: 10-30 cm circumference
- Historic/heritage trees: 300+ cm circumference
