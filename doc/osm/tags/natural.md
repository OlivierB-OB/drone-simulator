...
The drone simulator uses `natural` tags for terrain rendering via `vegetationMeshConfig` and `groundColors`:

**Forest areas (color #3a7a30):**
- `wood` - Wooded areas
- `forest` - Forests

**Scrub/shrubland (color #5a8a40):**
- `scrub` - Shrubland vegetation

**Special vegetation (via landuse):**
- Orchards, vineyards, grassland via `landuse` tag primarily

**Geological/special (various colors):**
- `bare_rock` (color #b8a888)
- `scree` (color #c0b090)
- `glacier` (color #e8f0ff)
- `grassland` (color #90b860)
