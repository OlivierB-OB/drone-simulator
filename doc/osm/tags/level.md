...
The drone simulator uses `level` tags for organizing building components (building parts, shops, rooms, etc.):

**Typical usage:**
- `0` - Ground floor shops, entrances
- `1` - First floor apartments/offices
- `-1` - Basement, underground parking
- `2`, `3` - Upper floors

**Multi-level features:**
- Atriums, shafts, and connecting features often span multiple levels
