...
The drone simulator uses `water` tags for water body rendering in `TerrainCanvasRenderer`:

**Common water features (color #3a6ab0):**
- `lake` - Natural lakes
- `pond` - Small ponds
- `reservoir` - Artificial reservoirs
- `canal` - Canals and channels

**Wetland areas (color #5a9a6a):**
- Water bodies mapped as areas
