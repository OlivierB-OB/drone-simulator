...
The drone simulator does not use the `lanes` tag for rendering currently. This tag is documented for data completeness and future enhancements:

**Typical road lane distributions:**
- Local/residential streets: 2 lanes
- Secondary roads: 2-3 lanes
- Primary/main roads: 4-6 lanes
- Motorways: 6-8+ lanes
